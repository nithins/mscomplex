...
***************************************************************************/
#ifndef QUAD_DATAMANAGER_UI
#define QUAD_DATAMANAGER_UI
...
class TreeModel : public QAbstractItemModel
{
  ...
  public:
    TreeModel ( tree<DataPiece *> *, QObject *parent = 0 );
    ~TreeModel();
    ...
    struct _treeitem
    {
      ...
      _treeitem ( DataPiece * _node , _treeitem * par ) :node ( _node ),parent ( par )
      {
      }
  ...
  private:
    void setupModelData ( tree<DataPiece *> * );
